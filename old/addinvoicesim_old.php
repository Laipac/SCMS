                      ...
                      $.ajax({
                         ...
                         success: 
                             function(result){
                                 if(result==="success"){
                                     $('#statuslabel').text("");
                                     location.href='addpmodelsim.php?invNum='+$('#invNum').val();
                                 }
                                 else
                                 {
                    ...
                    <div class="scroller-inner">
                            ...
                            <div class="content clearfix">
                                ...
                                <div class="block block-30 clearfix">
                                    <p><input type="button" value="Add Product Model" onclick="location.href='addpmodelsim.php?invNum='+$('#invNum').val();"></input></p>
