                    ...
                    <div class="scroller-inner">
                            ...
                            <div class="content clearfix">
                                ...
                                <div class="block block-30 clearfix">
                                    ...
                                    <p><input type="button" value="Add New Invoice" onclick="location.href='addinvoice.php?invoice=LP'+$('#frstInv').val();"></input></p>
                                     <p><input type="button" value="Edit Invoice" onclick="location.href='editinvoice.php?invoice=LP'+$('#frstInv').val();"></input></p>
