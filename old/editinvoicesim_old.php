                            ...
                            function(result){
                                ...
                                if(result==="failed"){
                                   ...
                                   var arrResult = JSON.parse(result);                               
                                    ...
                                    if($('#invType').val()==="SIM"){
                                        $('#qtyofsim').val(arrResult['qtyofsim']);
                                    }
                    ...
                    <div class="scroller-inner">
                            ...
                            <div class="content clearfix">
                                    <div class="block block-35 clearfix">
                                       ...
                                       <p> <label for="invType">Invoice Type:<input type="text" name="invType" id="invType" value="SIM" readonly/></label></p>
                                ...
                                <div class="block block-30 clearfix">
                                    <p><input type="button" value="Edit Product Model" onclick="location.href='editpmodelsim.php?invoice='+$('#invNum option:selected').val();"></input></p>
