                    ...
                    <div class="scroller-inner">
                            ...
                            <div class="content clearfix">
                                ...
                                <div class="block block-30 clearfix">
                                    ...
                                    <p><input type="button" value="Add New Invoice" onclick="location.href='addinvoicesim.php?invoice=LP'+$('#frstInv').val();"></input></p>
                                     <p><input type="button" value="Edit Invoice" onclick="location.href='editinvoicesim.php?invoice=LP'+$('#frstInv').val();"></input></p>
                                     <p><input type="button" value="Submit" onclick="location.href='menu.php';"></input></p>
