...
<script type="text/javascript">
                            ...
                            function(result){
                                ...
                                if(result==="failed"){
                                   ...
                                   var arrResult = JSON.parse(result);                               
                                    $('#qty').val(arrResult['quantity']);
                                    $('#qtyofsim').val(arrResult['quantityofsim']);
                                    $('#serviceplan').val(arrResult['serviceplan']);
                                    $('#billingcycle').val(arrResult['billingcycle']);
                                     $('#startDate').val(arrResult['startDate']);
                                      $('#renewalDate').val(arrResult['renewalDate']); 
                                       $('#endingDate').val(arrResult['endingDate']);
            ...
            function updateProd(btnValue){
                if ($('#qty').val()===""){
                    ...
                    alert("Kindly enter renewal date.");
                }
                else if ($('#endingDate').val()===""){
                    alert("Kindly enter ending date.");
                }
                else{
            ...
            <div class="scroller"><!-- this is for emulating position fixed of the nav -->
                    <div class="scroller-inner">
                            ...
                            <div class="content clearfix">
                                ...
                                <div class="block block-35 clearfix">
                                    <p> <label for="billingcycle">Billing Cycle:<input type="text" name="billingcycle" id="billingcycle" value="" /></label></p>
                                    <p> <label for="startDate">Start Date:<input type="text" name="startDate" id="startDate" value=""/></label></p>
                                    <p> <label for="renewalDate">Renewal Date:<input type="text" name="renewalDate" id="renewalDate" value=""/></label></p> 
                                    <p> <label for="endingDate">Ending Date:<input type="text" name="endingDate" id="endingDate" value=""/></label></p>
