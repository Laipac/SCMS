<!--
This module is for adding platform.
-->
...
<title>Add Platform - SIM CARD Management System</title>
     ...
     $.ajax({
         ...
         success: 
            ...
            function addplatform(){
                ...
                if (platformname===""){
                     alert("Kindly enter platform name.");
                }
                else{                      
                    $.ajax({
                      url: "addplatformname.php",
                      type: "POST",
                      data: {
                      ...
                      success: 
                          function(result){
                              ...
                              if(result === "success"){
                                  $('#statuslabel').show();
                                  $('#statuslabel').text("Platform created");
                                    $('#statuslabel').fadeOut(4000);
                              }
                              else if(result === "exists"){
                                   $('#statuslabel').show();
                                   $('#statuslabel').text("Platform exists");
                                    $('#statuslabel').fadeOut(4000);
                              }
                              else
                              {
                                  $('#statuslabel').show();
                                  $('#statuslabel').text("Error creating platform.");
                                  $('#statuslabel').fadeOut(4000);
                              }
                          }
                     });  
        ...
        <div class="mp-pusher" id="mp-pusher" >         
            ...
            <div class="scroller"><!-- this is for emulating position fixed of the nav -->
                    <div class="scroller-inner" id="pagecontent">
                           <!-- <div class="content clearfix"> --><!-- comment out div to remove padding from navbar to inputs -->
                                <div class="block block-35 clearfix">
                                    <p><a href="#" id="trigger" class="menu-trigger" style="display:none;">Create</a></p>
                                   
                                    
                                    <p> <label for="platformname">Platform Name:<input type="text" name="platformname" id="platformname" value="" /></label></p>
