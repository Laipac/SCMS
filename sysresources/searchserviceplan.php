<!--
This module is for searching service plans
-->
                                ...
                                <div class="block block-80 clearfix">
                                    ...
                                    <div class="tablelayout" style="font-size:50%;">
                                        <div class="tableheading">
                                            ...
                                            $sql= $conn->prepare('SELECT serviceplan.planid,serviceplan.plantype,serviceplan.planrate,serviceplan.plancurrency,simcardmaster.simtype FROM serviceplan INNER JOIN simcardmaster ON simcardmaster.simid=serviceplan.simcardtype');
                                            $sql->execute();
                                            $sql->bind_result($planid,$plantype,$planrate,$plancurrency,$simtype);
                                            $i=1;
                                            while($sql->fetch())
                                            {?>
                                              <div class="tablerow" id="tablerow<?php echo $i; ?>">
                                                  ...
                                                  <div class="tablecell">
                                                      <p>
                                                          <span id="spansimcardtype<?php echo $i; ?>"><?php echo $simtype; ?></span>
                                                       </p>
                                                  </div>
