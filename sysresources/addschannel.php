<!--
This module is for adding sales channels
-->
...
<title>Add Channel - SIM CARD Management System</title>
    ...
    $.ajax({
         ...
         success: 
            ...
            function addchannel(){
                ...
                if (channelname===""){
                     alert("Kindly enter channel name.");
                }
                else{                      
                    $.ajax({
                      url: "addschannelname.php",
                      type: "POST",
                      data: {
                      ...
                      success: 
                          function(result){
                              ...
                              if(result === "success"){
                                  $('#statuslabel').show();
                                  $('#statuslabel').text("Sales channel created.");
                              ...
                              {
                                  $('#statuslabel').show();
                                  $('#statuslabel').text("Error creating sales channel.");
                                  $('#statuslabel').fadeOut(4000);
                              }
                          }
                     });  
            ...
            <div class="scroller"><!-- this is for emulating position fixed of the nav -->
                    <div class="scroller-inner" id="pagecontent">
                                ...
                                <div class="block block-35 clearfix">
                                    ...
                                    <p> <label for="channelname">Channel Name:<input type="text" name="channelname" id="channelname" value="" /></label></p>
                                    <p><input type="button" value="Add" onclick="addchannel();" class="btncreate"></input></p>
