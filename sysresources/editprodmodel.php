<!--
This module is for modifying product model.
-->
...
<title>Edit Product Model - SIM CARD Management System</title>
              ...
              success: 
                  function(result){
                      ...
                      if(result === "success"){
                          ...
                          $('#statuslabel').fadeOut(4000);
                          $('input[type=text][name='+ $('#selectedproductmodel').val()+']').val($('#spanvalue'+($('#selectedproductmodel').val())).text());
                          $('input[type=text][name='+ $('#selectedproductmodel').val()+']').hide();
                          $('#spanvalue'+$('#selectedproductmodel').val()).show(); 
            ...
            <div class="scroller"><!-- this is for emulating position fixed of the nav -->
                    <div class="scroller-inner" id="pagecontent">
                                    ...
                                    <div class="tablelayout">
                                        <div class="tableheading">
                                            ...
                                            {?>
                                              <div class="tablerow">
                                                  <div class="tablecell">
                                                      <p><input type="radio" id="productmodelname" name="productmodelname" value="<?php echo $productmodelid; ?>" onclick="editproductmodel(this.value)"/></p>
                                                  </div>
                                                  <div class="tablecell">
                                                      <p>
                                                          <span id="spanvalue<?php echo $productmodelid; ?>"><?php echo $productmodelname; ?></span>
                                                          <input type="text" id="productmodeltext" name="<?php echo $productmodelid; ?>" value="<?php echo $productmodelname; ?>" style="display:none;"/>
                                                      </p>
                                                  </div>
                                              </div>
                                            <?php
                                ...
                                <div class="block block-30 clearfix">
                                    ...
                                    <p><input type="button" value="Save" id="updatevalue" onclick="updateproductmodel()" disabled="disabled" class="btnedit"></input></p>
                                    <p><input type="button" value="Cancel" id="cancelbutton" onclick="cancelproductmodel()" disabled="disabled" class="btncancel"></input></p>
