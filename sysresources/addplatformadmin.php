<!--
This module is for adding platform admin.
-->
...
<title>Add Platform Admin - SIM CARD Management System</title>
    ...
    $.ajax({
         ...
         success: 
            ...
            function addplatform(){
                var platformname = $('#platformadmin').val().trim();
                
                if (platformname===""){
                     alert("Kindly enter platform admin.");
                }
                else{   
                   
                    $.ajax({
                      url: "addplatformadminrec.php",
                      type: "POST",
                      data: {
                          platformadmin:platformname,
                      ...
                      success: 
                          function(result){
                              ...
                              if(result === "success"){
                                    $('#statuslabel').show();
                                  $('#statuslabel').text("Platform admin to created");
                              ...
                              {
                                    $('#statuslabel').show();
                                  $('#statuslabel').text("Error creating platform admin to.");
                                   $('#statuslabel').fadeOut(4000);
                              }
                          }
                     });  
