<!--
This module is for service management.
-->
...
<title>Service Management - SIM CARD Management System</title>
...
function getserviceplan(productmodel){
    ...
    $.ajax({
        ...
        success: function(result) {
           ...
           function addproductmodel(invoicenumber,productmodel){
                ...
                var selectprodmodel = "<select name=\"prodModel"+ (parseInt($('#productcount').val())+1) + "\" id=\"prodModel"+(parseInt($('#productcount').val())+1)+ "\" onchange=\"getserviceplan(this);\" disabled=true><option value=\"Blank\"><--SELECT--></option>";  
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        getserviceplan(productmodel);
                    }
                });
           }
           function addsim(invoicenumber,productmodel){
...
function setproductdetails(invoicenumber,productmodel){
      $.ajax({
            url: "retrieveInv.php",
            type: "POST",
            data: {invNum:invoicenumber,
               invType:$('#invType').val()
            },
            success: 
                function(result){
    ...
    if($('#invType').val()==="SIM"){
      ...
      $('#listproducts').hide();
      $('#btnaddproduct').show();
      addsim(invoicenumber,productmodel);
      ...
      $('hr').remove();
      $('#listproducts').hide();
      addproductmodel(invoicenumber,productmodel);
       $('#btnaddproduct').show();
      $('#paraproductmodelrenew').hide();
         $('#para1').show();
    }
...
function setinvoices(invoicetype,invoicenumber,productmodel){
             $.ajax({
                    url: 'getinvoices.php',
                    type: 'POST',
                    data: {
                    ...
                    success: function(data) {
                        ...
                        $('#prodModel1').val("");
                        $('#listproducts').hide();
                        setproductdetails(invoicenumber,productmodel);
                    }
                });
}
                ...
                success: 
                    function(result){
                        ...
                        if(result==="success"){
                           ...
                           $('#simstatuslabel').text("Error modifying details.");
...
function searchval(){
    if($('#searchval').val()===""){
    ...
    else if($('#searchby').val()==='Blank'){
        alert('Search criteria is blank.');
    }
    else{
        if($('#searchby').val()==='Locator'){
            $.ajax({
                url: "searchbylocator.php",
                type: "POST",
                data: {
                ...
                success: 
                    function(result){
                        ...
                        if(result==="failed"){
                            ...
                            $('#searchstatuslabel').text("Locator ID does not exist or product has not been assigned a service yet.");
                             $('#searchstatuslabel').fadeOut(3000);
                        }
                        else{
                            $('#searchstatuslabel').text("");
                            $('#searchstatuslabel').show();
                            $('#searchstatuslabel').text("Check and modify details on the respective tabs.");
                            $('#searchstatuslabel').fadeOut(3000);
                            $.ajax({
                                ...
                                success: 
                                    function(data){
                                        ...
                                        if(data==="failed"){
                                             $('#searchstatuslabel').show();
                                            $('#searchstatuslabel').text("Error retrieving customer details.");
                                             $('#searchstatuslabel').fadeOut(3000);
                                        }
                                        else{
                                            ...
                                            $('#frstInv').val(arrResult.frstInv);
                                            $('#searchcust').val(arrResult.frstInv);
                                            $('#invType').val(arrResult.invType);
                                            setinvoices(arrResult.invType,arrResult.invNum,result);
                                        }
                                    }
                            });    
                        }
        ...
        else if($('#searchby').val()==='IMEI'){
             $.ajax({
                url: "searchbyimei.php",
                type: "POST",
                data: {
                  searchval:$('#searchval').val()
                },
                success: 
                    function(result){
                        ...
                        if(result==="failed"){
                             $('#searchstatuslabel').show();
                              $('#searchstatuslabel').text("");
                            $('#searchstatuslabel').text("IMEI does not exist.");
                             $('#searchstatuslabel').fadeOut(3000);
                        }
                        else{
                            $('#searchstatuslabel').text("");
    ...
    <div class="container">
        <div class="mp-pusher" id="mp-pusher">         
                <nav id="mp-menu" class="mp-menu">
                    <div class="mp-level">
                        <h2 class="icon icon-world">Service Management</h2>
                        <ul>
                            <li class="icon icon-arrow-left">
                                <a class="icon icon-display" href="servicemgmt.php" style="background-color:aqua;">Service Management</a>
                ...
                <div class="scroller-inner">
                                ...
                                <div class="block block-80 clearfix">
                                        <p><a href="#" id="trigger" class="menu-trigger" style="display:none;">Menu</a></p>
                                             <p style="float:right;">
                                                <input type="button" value="Save" id="btnSave" onclick="addtoinvoice(this);"></input>
                                                ...
                                                <div id="tab1" class="tab active">
                                                    <p>
                                                         ...
                                                         <select name="searchby" id="searchby">
                                                             ...
                                                             <option value="Locator">Locator ID</option>
                                                ...
                                                <div id="tab4" class="tab">
                                                    ...
                                                    <label for="searchcust">Customer:
                                                     ...
                                                     <p> <label for="invType">Invoice Type:</label>
                                                         <select name="invType" id="invType" disabled="true">
                                                             <option value="Blank"><--Select--></option>
                                                    ...
                                                    <p> 
                                                        <label for="invNum">Invoice#: </label>
                                                          <select name="invNum" id="invNum" disabled="true">
                                                             <option value="Blank"><--Select--></option>
                                                          </select>
                                                    </p>
