<!--
this module is for activating and deactivating sim under sim inventory module
-->
...
<script type="text/javascript">
                   ...
                   $.ajax({
                        ...
                        success: 
                           function(result){
                                ...
                                {    
                                     $("#activatedeactivate option[value='Activate']").remove();
                                 ...
                                 $.ajax({
                                    ...
                                    success: 
                                       function(result){
                                            ...
                                            {    
                                                 $("#activatedeactivate option[value='Deactivate']").remove();

                                            }
                                            if ($('#activatedeactivate option').length === 0) {
                                                $('#pagecontent').empty(); 
                        ...
                        function(result){
                            ...
                            if(result==="failed"){
                               ...
                               $('#simnumber1').val($('#simnumber').val());
                                ...
                                $('#statuslabel').text("SIM details on the Activation, Deactivation tab.");
                            }
                        }
            });
        }
    }
    //code that gets sim group details
    ...
    function setsim(){
        if($('#telnumber').val()===""){
            ...
            $.ajax({
                    url: "updactideacti.php",
                    type: "POST",
                    data: {
                        simnumber:$('#simnumber').val(),
                        simgroup:$('#simtype').val(),
                        simaction:$('#activatedeactivate').val(),
                    ...
                    success: 
                        function(result){
                            ...
                            if(result==="failed"){
                                if($('#activatedeactivate').val()==='Activate'){
                                    $('#statuslabel1').text("Error activating SIM.");
                                }
                                else{
                                    $('#statuslabel1').text("Error deactivating SIM.");
                                }
                            }
                            
                            else{
                                if($('#activatedeactivate').val()==='Activate'){
                                    $('#statuslabel1').text("SIM activated.");
                                }
                                else{
                                    $('#statuslabel1').text("SIM deactivated.");
                                }
    ...
    //changes label text based on chosen selection either to activate or deactivate sim.
    function setaction(){
        if($('#activatedeactivate').val()==="Activate"){
            $('#lblactivationdate').text("Activation Date:");
        }
        else{
          $('#lblactivationdate').text("Deactivation Date:");  
        }
    }
</script>
        ...
        <div class="mp-pusher" id="mp-pusher">         
                <nav id="mp-menu" class="mp-menu">
                    <div class="mp-level">
                        ...
                        <ul>
                            <li class="icon icon-arrow-left">
                                <a class="icon icon-display" href="actideactisim.php" style="background-color:aqua;">Activation & Deactivation</a>
                            ...
                            <div class="block block-80 clearfix">
                                ...
                                <div class="tabs">
                                    <ul class="tab-links">
                                        ...
                                        <li><a href="#tab2">Activation, Deactivation</a></li>
                                    </ul>
                                    <div class="tab-content">
                                        ...
                                        <div id="tab2" class="tab">
                                            ...
                                            <p> 
                                                <label for="offlineonline">Type: </label>                                         
                                                    <select name="offlineonline" id="offlineonline">
                                                        <option value="online">On-line</option>
                                                        <option value="offline">Off-line</option>
                                                 </select>
                                            </p>
                                            <p> 
                                                <label for="activatedeactivate">Action: </label>                                         
                                                    <select name="activatedeactivate" id="activatedeactivate" onchange="setaction();">
                                           ...
                                           <!--
                                            ...
                                            <p id="paraactivationdate1"> 
                                             ...
                                             <p id="parabeforedate1"> 
                                                ...
                                                <input type="text" name="beforedate" id="beforedate" value="" class="noedit" readonly="readonly" />
                                            </p>
                                            <p id="parainventorystatus1"> 
                                                <label for="inventorystatus">Inventory Status:</label>                                       
                                                    <select name="inventorystatus" id="inventorystatus" disabled>
                                            ...
                                            <p id="parastoragelocation1"> 
                                                ...
                                                <input type="text" name="storagelocation" id="storagelocation" value="" class="noedit" readonly="readonly"/>     
                                            </p>
                                            <p id="paraimei1"> 
                                                <label for="imei">IMEI No.:</label>                                       
                                                <input type="text" name="imei" id="imei" value="" class="noedit" readonly="readonly"/>   
                                            </p>
                                            <p id="paraproductmodel1"> 
                                                <label for="productmodel">Product Model:</label>                                       
                                                 <select name="productmodel" id="productmodel" disabled>
                                                           <option value="Blank"><--Select--></option>
                                                          <?php 
                                            ...
                                            <p>
                                                 <input type="button" value="Submit" id="btnSubmit" onclick="setsim();"/>
                                            </p>
                                        </div>
                                    </div>
                                </div>
