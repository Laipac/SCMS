<!--
This module is for modifying invoices linked to an IMEI.
-->
...
<title>Edit Product to Invoice - SIM CARD Management System</title>
                ...
                success: 
                    function(result){
                        ...
                        if(result==="failed"){
                            ...
                            $('#simstatuslabel').show();
                           $('#simstatuslabel').text("Product modified.");
                           $('#simstatuslabel').fadeOut(10000);
                        }
                    }
            });
