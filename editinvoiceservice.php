<!--
This module is for modifying invoices with assigned service
-->
...
<title>Edit Service to Invoice - SIM CARD Management System</title>
        ...
        <div class="mp-pusher" id="mp-pusher">         
                <nav id="mp-menu" class="mp-menu">
                    <div class="mp-level">
                        ...
                        <ul>
                            <li class="icon icon-arrow-left">
                                <a class="icon icon-display" href="editinvoiceservice.php" style="background-color:aqua;">Edit</a>
                            </li>
                        </ul>
