<!--
This module adds sim to invoice
-->
...
<title>Add SIM to Invoice - SIM CARD Management System</title>
                    ...
                    if(btnValue.value==='Save'){
                        ...
                        if($('#invType').val()==="Product, SIM and Service"){
                            while(i < prodcount){
                              ...
                              invoicestatus='Waiting for Product';
                        }
...
//Set product models after invoice selection
...
//Set invoice numbers after invoice type selection
...
function addtoinvoice(){
    ...
    var simtextarea = $("#simtoadd").val();   
    var simcount = simtextarea.split("\n");
    simcount.length;
    ...
    else if(parseInt($('#qtysim1').val()) > simcount.length){
         alert("Number of sims should not be less than "+$('#qtysim1').val()+". Quantity of SIM in the product model should be modified to decrease SIM.");
    }
    else if(parseInt($('#qtysim1').val()) < simcount.length){
      
         alert("Number of sims should not be greater than "+$('#qtysim1').val()+". Quantity of SIM in the product model should be modified to add more SIM.");
    }
    else{
     $.ajax({
                url: "checksiminventory.php",
                type: "POST",
                data: {
                    
                    simnumber:$('#simtoadd').val(),
                    ...
                    function(result){
                        ...
                        if(result==="failed"){
                           ...
                           while(x<arrResult.length){
                               ...
                               if(arrResult[x].indexOf('Error')>-1){
                                   z++;
                               }
                            x++;
                           }
                                                ...
                                                <div id="tab3" class="tab">
                                                    ...
                                                    <div style="width: 55%; float:left">
                                                        ...
                                                        <p>
                                                            ...
                                                            <textarea id="simtoadd" rows="15" cols="25" class="noedit" readonly="readonly" ></textarea>
